...
/home/ubuntu/.ssh/id\_rsa (private key)

/home/ubuntu/.ssh/id\_rsa.pub (public key)
...
wget https://github.com/aquasecurity/trivy/releases/download/v0.48.0/trivy\_0.48.0\_Linux-64bit.deb

sudo dpkg \-i trivy\_0.48.0\_Linux-64bit.deb
...
Private Key: /home/ubuntu/.ssh/id\_rsa

Public Key must be added to: biddfeuat@UAT-SERVER:~/.ssh/authorized\_keys
...
│       └── web.bidd.application/     ← BUILD\_PATH (Main workspace)

│           ├── .next/                ← Generated after build

│           ├── public/               ← Static files

│           ├── node\_modules/         ← Dependencies (after yarn install)
...
└── prodConf/                         ← PRODCONF\_PATH (Config repo)
...
                        if \[ ! -d "${env.PRODCONF\_PATH}" \]; then

                            git clone ${env.CONF\_REPO\_URL} ${env.PRODCONF\_PATH}

                        fi

                        cd ${env.PRODCONF\_PATH}
...
Clone Location: /home/ubuntu/workspace/bidd\_ui\_uat/web.bidd.application
...
    /home/ubuntu/workspace/bidd\_ui\_uat/web.bidd.application
...
  cp ${PRODCONF\_PATH}/biddEasy/uat/bidd2.0/next.config.ts .
...
Report Location: ${WORKSPACE}/trivy\_report.txt

Full Path: /home/ubuntu/workspace/bidd\_ui\_uat/trivy\_report.txt
...
         \--output /home/ubuntu/workspace/bidd\_ui\_uat/trivy\_report.txt \\
...
Location: /home/ubuntu/workspace/bidd\_ui\_uat/web.bidd.application
...
To: /home/ubuntu/workspace/bidd\_ui\_uat/web.bidd.application/next.config.ts

↓

Step 5: Install Dependencies

Working Directory: /home/ubuntu/workspace/bidd\_ui\_uat/web.bidd.application

Command: /home/ubuntu/.nvm/versions/node/v20.11.1/bin/yarn install

Creates: node\_modules/ directory
...
# Stored in variable: ${APP\_SERVER\_IP}
...
/home/biddfeuat/.ssh/authorized\_keys
...
└── web.bidd.application/             ← DEPLOY\_PATH (Application directory)

    ├── .next/                        ← Copied from Jenkins (compiled code)

    ├── public/                       ← Copied from Jenkins (static files)

    ├── node\_modules/                 ← Copied from Jenkins (dependencies)
...
  ssh biddfeuat@${APP\_SERVER\_IP} "mkdir -p ${DEPLOY\_PATH}"
...
  scp \-r .next public package.json yarn.lock next.config.ts node\_modules \\

       biddfeuat@${APP\_SERVER\_IP}:${DEPLOY\_PATH}/

  
  

Source Location (Jenkins): /home/ubuntu/workspace/bidd\_ui\_uat/web.bidd.application/
...
├── node\_modules/       (entire directory \- all dependencies)
...
    .next public package.json yarn.lock next.config.ts node\_modules \\

    biddfeuat@${APP\_SERVER\_IP}:/home/biddfeuat/web.bidd.application/
...
Condition: ${WORKSPACE}/trivy\_report.txt exists AND contains vulnerabilities

Subject: \[SECURITY ALERT\] Vulnerabilities Found \- ${JOB\_NAME} #${BUILD\_NUMBER}

Attachment: trivy\_report.txt
...
Subject: \[SECURITY ALERT\] Vulnerabilities Found \- bidd\_ui\_uat #123

  

HTML Body:

\- Job Name: bidd\_ui\_uat
...
Attachment: trivy\_report.txt (contains vulnerability details)
...
│ └─ Result: APP\_SERVER\_IP \= 10.0.1.50                            │
...
│ │  Location: /home/ubuntu/workspace/bidd\_ui\_uat/               │
...
│ │  To: /home/ubuntu/workspace/bidd\_ui\_uat/                     │
...
│ │  Creates: node\_modules/ (500 MB)                              │

│ ├─ Security scan                                                │

│ │  Command: trivy fs .                                          │

│ │  Output: /home/ubuntu/workspace/bidd\_ui\_uat/                 │
...
                     │ Files: .next/, public/, node\_modules/,
...
                     │       bidd\_ui\_uat/web.bidd.application/
...
│ ├─ Check: trivy\_report.txt exists?                              │
...
├─ Path: /home/ubuntu/workspace/bidd\_ui\_uat/web.bidd.application/
...
├─ Destination: /home/ubuntu/workspace/bidd\_ui\_uat/web.bidd.application/next.config.ts
...
├─ Creates: node\_modules/ directory (~500 MB)
...
│           \--format table \--output /home/ubuntu/workspace/bidd\_ui\_uat/trivy\_report.txt .

├─ Scans: Source code + node\_modules/
...
Result: Build artifacts ready at /home/ubuntu/workspace/bidd\_ui\_uat/web.bidd.application/
...
├─ Source: /home/ubuntu/workspace/bidd\_ui\_uat/web.bidd.application/
...
├─ Check: /home/ubuntu/workspace/bidd\_ui\_uat/trivy\_report.txt exists?
